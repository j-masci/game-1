...
class Events:
    def __init__(self):
        ...
        self.key_up_events = []
        self._key_mods = _get_key_mods_map()
        self._keys = _get_keys_map()
    ...
    def map_key(self, key_str, key_int=None):
        ...
        # if this fails its likely you called map_key(something)
        # rather than map_key(None, something)
        return self._keys[str(key_str)]
